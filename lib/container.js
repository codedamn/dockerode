 ...
 * @param  {Function} callback Callback
 */
Container.prototype.changes = function(callback, opts) {
	var self = this
	var optsf = {
 ...
 */
Container.prototype.export = function(callback, opts) {
	var self = this
	var optsf = {
...
Container.prototype.attach = function(opts, callback) {
	...
	if (args.callback === undefined) {
		return new this.modem.Promise(function(resolve, reject) {
			self.modem.dial(args.cookie, optsf, function(err, stream) {
				if (err) {
					return reject(err)
				}
				resolve(stream)
		...
		this.modem.dial(args.cookie, optsf, function(err, stream) {

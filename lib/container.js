 ...
 */
var Container = function(modem, id, cookie) {
	this.modem = modem
	this.id = id
	this.cookie = cookie
...
Container.prototype.inspect = function(opts, callback) {
	...
	if (args.callback === undefined) {
		return new this.modem.Promise(function(resolve, reject) {
			self.modem.dial(self.cookie, optsf, function(err, data) {
				if (err) {
					return reject(err)
				}
				resolve(data)
		...
		this.modem.dial(self.cookie, optsf, function(err, data) {
...
Container.prototype.exec = function(opts, callback) {
	...
	if (args.callback === undefined) {
		return new this.modem.Promise(function(resolve, reject) {
			self.modem.dial(self.cookie, optsf, (err, data) => {
				if (err) {
					return reject(err)
				}
		...
		this.modem.dial(self.cookie, optsf, (err, data) => {
...
Container.prototype.attach = function(opts, callback) {
	...
	if (args.callback === undefined) {
		return new this.modem.Promise(function(resolve, reject) {
			self.modem.dial(self.cookie, optsf, function(err, stream) {
				if (err) {
					return reject(err)
				}
				resolve(stream)
		...
		this.modem.dial(self.cookie, optsf, function(err, stream) {

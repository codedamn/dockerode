...
Docker.prototype.createContainer = function(opts, callback) {
	...
	if (callback === undefined) {
		return new this.modem.Promise(function(resolve, reject) {
			self.modem.dial(opts && opts.cookie, optsf, (err, data) => {
				if (err) {
					return reject(err)
				}
				resolve(self.getContainer(data.Id, opts && opts.cookie))
			})
		})
	} else {
		this.modem.dial(opts && opts.cookie, optsf, function(err, data) {
			if (err) return callback(err, data)
			callback(err, self.getContainer(data.Id, opts && opts.cookie))
		})
	}
}
...
Docker.prototype.createImage = function(auth, opts, callback) {
	...
	if (callback === undefined) {
		return new this.modem.Promise(function(resolve, reject) {
			self.modem.dial(opts && opts.cookie, optsf, function(err, data) {
				if (err) {
					return reject(err)
				}
				resolve(data)
 ...
 */
Docker.prototype.getContainer = function(id, cookie) {
	return new Container(this.modem, id, cookie)
}
 ...
 */
Docker.prototype.getImage = function(name, cookie) {
	return new Image(this.modem, name, cookie)
}
 ...
 */
Docker.prototype.getVolume = function(name, cookie) {
	return new Volume(this.modem, name, cookie)
}
 ...
 * @param {String} name Volume's name
 */
Docker.prototype.getPlugin = function(name, remote, cookie) {
	return new Plugin(this.modem, name, remote, cookie)
}
 ...
 */
Docker.prototype.getService = function(id, cookie) {
	return new Service(this.modem, id, cookie)
}
 ...
 */
Docker.prototype.getTask = function(id, cookie) {
	return new Task(this.modem, id, cookie)
}
 ...
 */
Docker.prototype.getNode = function(id, cookie) {
	return new Node(this.modem, id, cookie)
}
 ...
 */
Docker.prototype.getNetwork = function(id, cookie) {
	return new Network(this.modem, id, cookie)
}
 ...
 * @param {String} id network's id
 */
Docker.prototype.getSecret = function(id, cookie) {
	return new Secret(this.modem, id, cookie)
}
 ...
 * @param {String} id network's id
 */
Docker.prototype.getConfig = function(id, cookie) {
	return new Config(this.modem, id, cookie)
}
 ...
 */
Docker.prototype.getExec = function(id, cookie) {
	return new Exec(this.modem, id, cookie)
}
...
Docker.prototype.listContainers = function(opts, callback) {
	...
	if (args.callback === undefined) {
		return new this.modem.Promise(function(resolve, reject) {
			self.modem.dial(args.cookie, optsf, function(err, data) {
				if (err) {
					return reject(err)
				}
				resolve(data)
		...
		this.modem.dial(args.cookie, optsf, function(err, data) {
	...
	if (callback === undefined) {
		return new this.modem.Promise(function(resolve, reject) {
			self.modem.dial(opts && opts.cookie, optsf, function(err, data) {
				...
				resolve(self.getService(data.ID || data.Id, opts && opts.cookie))
			})
		})
	} else {
		this.modem.dial(opts && opts.cookie, optsf, function(err, data) {
			if (err) return callback(err, data)
			callback(err, self.getService(data.ID || data.Id, opts && opts.cookie))
		})
	}
}

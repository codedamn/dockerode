	...
	if (args.callback === undefined) {
		return new this.modem.Promise(function(resolve, reject) {
			self.modem.dial(args.cookie, args.serverid, optsf, function(err, data) {
				...
				resolve(self.getSecret(data.ID, args.cookie))
			})
		})
	} else {
		this.modem.dial(args.cookie, args.serverid, optsf, function(err, data) {
			if (err) return args.callback(err, data)
			args.callback(err, self.getSecret(data.ID, args.cookie))
		})
	}
}
	...
	if (args.callback === undefined) {
		return new this.modem.Promise(function(resolve, reject) {
			self.modem.dial(args.cookie, args.serverid, optsf, function(err, data) {
				...
				resolve(self.getConfig(data.ID, args.cookie))
			})
		})
	} else {
		this.modem.dial(args.cookie, args.serverid, optsf, function(err, data) {
			if (err) return args.callback(err, data)
			args.callback(err, self.getConfig(data.ID, args.cookie))
		})
	}
}
	...
	if (args.callback === undefined) {
		return new this.modem.Promise(function(resolve, reject) {
			self.modem.dial(args.cookie, args.serverid, optsf, function(err, data) {
				...
				resolve(self.getNetwork(data.Id, args.cookie))
			})
		})
	} else {
		this.modem.dial(args.cookie, args.serverid, optsf, function(err, data) {
			if (err) return args.callback(err, data)
			args.callback(err, self.getNetwork(data.Id, args.cookie))
		})
	}
}

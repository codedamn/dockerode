		...
		return new this.modem.Promise(function(resolve, reject) {
			self.modem.dial(
				...
				(err, data, mybackend) => {
					...
					resolve([self.getContainer(data.Id, opts && opts.cookie, mybackend), mybackend])
				}
			)
		})
	} else {
		this.modem.dial(opts && opts.cookie, opts && opts.serverid, optsf, function(
			err,
			data,
			mybackend
		) {
			if (err) return callback(err, data)
			callback(err, [self.getContainer(data.Id, opts && opts.cookie, mybackend), mybackend])
		})
	}
}
...
Docker.prototype.createImage = function(auth, opts, callback) {
	...
	if (callback === undefined) {
		return new this.modem.Promise(function(resolve, reject) {
			self.modem.dial(opts && opts.cookie, opts && opts.serverid, optsf, function(err, data) {
				if (err) {
					return reject(err)
				}
				resolve(data)
		...
		this.modem.dial(opts && opts.cookie, opts && opts.serverid, optsf, function(err, data) {
			callback(err, data)
		})
	}
}
	...
	function build(file) {
		...
		if (callback === undefined) {
			return new self.modem.Promise(function(resolve, reject) {
				self.modem.dial(opts && opts.cookie, opts && opts.serverid, optsf, function(
					err,
					data
				) {
					if (err) {
 ...
 */
Docker.prototype.getContainer = function(id, cookie, serverid) {
	return new Container(this.modem, id, cookie, serverid)
}
 ...
 */
Docker.prototype.getImage = function(name, cookie, serverid) {
	return new Image(this.modem, name, cookie, serverid)
}
 ...
 */
Docker.prototype.getVolume = function(name, cookie, serverid) {
	return new Volume(this.modem, name, cookie, serverid)
}
 ...
 * @param {String} name Volume's name
 */
Docker.prototype.getPlugin = function(name, remote, cookie, serverid) {
	return new Plugin(this.modem, name, remote, cookie, serverid)
}
 ...
 */
Docker.prototype.getService = function(id, cookie, serverid) {
	return new Service(this.modem, id, cookie, serverid)
}
 ...
 */
Docker.prototype.getTask = function(id, cookie, serverid) {
	return new Task(this.modem, id, cookie, serverid)
}
 ...
 */
Docker.prototype.getNode = function(id, cookie, serverid) {
	return new Node(this.modem, id, cookie, serverid)
}
 ...
 */
Docker.prototype.getNetwork = function(id, cookie, serverid) {
	return new Network(this.modem, id, cookie, serverid)
}
 ...
 * @param {String} id network's id
 */
Docker.prototype.getSecret = function(id, cookie, serverid) {
	return new Secret(this.modem, id, cookie, serverid)
}
 ...
 * @param {String} id network's id
 */
Docker.prototype.getConfig = function(id, cookie, serverid) {
	return new Config(this.modem, id, cookie, serverid)
}
 ...
 */
Docker.prototype.getExec = function(id, cookie, serverid) {
	return new Exec(this.modem, id, cookie, serverid)
}
...
Docker.prototype.listContainers = function(opts, callback) {
	...
	if (args.callback === undefined) {
		return new this.modem.Promise(function(resolve, reject) {
			self.modem.dial(args.cookie, args.serverid, optsf, function(err, data) {
				if (err) {
					return reject(err)
				}
				resolve(data)
		...
		this.modem.dial(args.cookie, args.serverid, optsf, function(err, data) {
	...
	if (args.callback === undefined) {
		return new this.modem.Promise(function(resolve, reject) {
			self.modem.dial(args.cookie, args.serverid, optsf, function(err, data) {
				...
				resolve(self.getSecret(data.ID, args.cookie, args.serverid))
			})
		})
	} else {
		this.modem.dial(args.cookie, args.serverid, optsf, function(err, data) {
			if (err) return args.callback(err, data)
			args.callback(err, self.getSecret(data.ID, args.cookie, args.serverid))
		})
	}
}
	...
	if (args.callback === undefined) {
		return new this.modem.Promise(function(resolve, reject) {
			self.modem.dial(args.cookie, args.serverid, optsf, function(err, data) {
				...
				resolve(self.getConfig(data.ID, args.cookie, args.serverid))
			})
		})
	} else {
		this.modem.dial(args.cookie, args.serverid, optsf, function(err, data) {
			if (err) return args.callback(err, data)
			args.callback(err, self.getConfig(data.ID, args.cookie, args.serverid))
		})
	}
}
 ...
 * @param {Function} callback Callback
 */
Docker.prototype.pruneBuilder = function(callback, opts) {
	var self = this
	...
	if (callback === undefined) {
		return new this.modem.Promise(function(resolve, reject) {
			self.modem.dial(opts && opts.cookie, opts && opts.serverid, optsf, function(err, data) {
				...
				resolve(
					self.getService(data.ID || data.Id, opts && opts.cookie, opts && opts.serverid)
				)
			})
		})
	} else {
	...
	if (args.callback === undefined) {
		return new this.modem.Promise(function(resolve, reject) {
			self.modem.dial(args.cookie, args.serverid, optsf, function(err, data) {
				...
				resolve(self.getNetwork(data.Id, args.cookie, args.serverid))
			})
		})
	} else {
		this.modem.dial(args.cookie, args.serverid, optsf, function(err, data) {
			if (err) return args.callback(err, data)
			args.callback(err, self.getNetwork(data.Id, args.cookie, args.serverid))
		})
	}
}
 ...
 */
Docker.prototype.info = function(callback, opts) {
	var self = this
	var optsf = {
		path: '/info',
		method: 'GET',
 ...
 * @param  {Function} callback Callback
 */
Docker.prototype.version = function(callback, opts) {
	var self = this
	var optsf = {
		path: '/version',
		method: 'GET',
 ...
 * @param  {Function} callback Callback
 */
Docker.prototype.ping = function(callback, opts) {
	var self = this
	var optsf = {
		path: '/_ping',
		method: 'GET',
 ...
 * @param  {Function} callback Callback
 */
Docker.prototype.df = function(callback, opts) {
	var self = this
	var optsf = {
		path: '/system/df',
		method: 'GET',
...
Docker.prototype.runCallback = function(
	image,
	cmd,
	streamo,
	createOptions,
 ...
 * @param  {Function} callback Callback
 */
Docker.prototype.swarmInspect = function(callback, opts) {
	var self = this
	var optsf = {
		path: '/swarm',
		method: 'GET',
